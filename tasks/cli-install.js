...
const cliPackagePath = path.join(__dirname, '..', 'packages', 'react-fused-cli', 'package.json');
...
exec('npm link', { cwd: path.resolve('packages', 'react-fused-cli') }, (error, stdout, stderr) => {
  if (error) {
